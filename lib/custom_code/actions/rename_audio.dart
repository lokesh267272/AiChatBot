...
Future<FFUploadedFile> renameAudio(
  ...
  // In case we're unable to find the file extension, we just return the original file passed into
  // the action. This can happen during localhost development for example.
  if (match == null) {
    return audio;
  }
